...
class PLC(ABC):
    def __init__(self, name: str, program):
        ...
        self.program = program          # callable: program(plc) -> None
        self.input_image: dict[str, object] = {}
        self.output_image: dict[str, object] = {}

    def define_tag(self, tag_name, tag_type, initial_value=0, native_address=None):
    ...
    def read_input(self, tag_name):
        """Program must read physical inputs from the frozen image, not live."""
        return self.input_image[tag_name]

    def write_output(self, tag_name, value):
        """Program writes physical outputs to the image; pushed out at end of scan."""
